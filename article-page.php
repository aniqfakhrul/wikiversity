...
<div class="breadcrumb wrapper">
  <a href="../../culture.html"><?= $page['category'] ?></a>
    <div class="follow">
      <a href="https://facebook.com/thewikiversity"> Follow wikiversity &gt; <img src="s/mashable/follow_placeholder.png" alt="" style="vertical-align:middle; margin-left: 30px;"></a>
  </div>
</div>
...
<div id="content">
<article itemscope class="article ARTICLE">
  ...
  <span itemprop="image" style="display: none" itemscope><meta itemprop="url" content="https://sm.mashable.com/mashable_sea/photo/default/johor-premium-outlets-shopping_du4f.jpg"><meta itemprop="width" content="770"><meta itemprop="height" content="419"></span>
  ...
  <div class="articleHero" itemscope>
  ...
  <div class="byline">
      <b>
        ...
        <span itemprop="author" itemscope class="microdata person">
<span id="id_author" itemprop="name">Wikiversity's Editor</span>
...
<meta itemprop="description" content="Sukhbir Cheema is a writer, playwright, theatre director and cartoonist based in Malaysia.">
  ...
  <div class="topics">TOPICS: <a href="#"><?= $page['category'] ?></a></div>
</article>
</div>
...
?>
<div class="sb">
  <a href="../1940/if-you-thought-southeast-asia-does-not-have-amazing-artists.html" class="thumb">
    <img src="img/thumbnail/video<?php echo $i ?>.jpg" srcset="img/thumbnail/video<?php echo $i ?>.jpg, img/thumbnail/video<?php echo $i ?>.jpg 2x" alt=""></a>
  <div class="sbc">
    <em class="topic"></em>
